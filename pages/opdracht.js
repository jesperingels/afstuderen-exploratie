...
const Opdracht = () => (
    <div>
      ...
      <Content>
        <h1>Vraagstuk</h1>
        <p>De opdrachtgever wil weten of het mogelijk is om ‘backoffice support’ te leveren in de fabrieken van Perfetti Van Melle wereldwijd. Met backoffice support wordt bedoeld dat er iemand aan de andere kant van de wereld geholpen moet kunnen worden met bijvoorbeeld het oplossen van storingen. De HoloLens was al in het bezit de snoepfabrikant, hier heb ik mijn onderzoek onder andere op gefocust. </p>
        <div className='img-wrapper'>
          <div className="img-placeholder width-60pr"></div>
          <img alt="illustratie van de aarde" className='width-30pr' src='/img/planet-earth.svg'/>
          <img alt="illustratie vrouw met headset" className='width-30pr' src='/img/support.svg'/>
        </div>
