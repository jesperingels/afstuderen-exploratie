    ...
    <div>
      ...
      <Content>
        ...
        <div className='img-wrapper'>
            ...
            <img className='width-30pr' src='/img/BoldlyLogo.png' />
        </div>
        ...
        <div className='img-wrapper'>
            <img className='width-30pr' src='/img/unity-logo.png' />
        </div>
        ...
        <h2>Divergeren - AI</h2>
        <div className="img-wrapper">
            <img className='width-80pr' src='/img/AI-brainstorm.jpg' />
        </div>
        ...
        <div className="img-wrapper">
            <img className='width-80pr' src='/img/AI-onderzoek.jpg' />
        </div>
