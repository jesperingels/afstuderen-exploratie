    ...
    <div>
      ...
      <Content>
        ...
        <div className='img-wrapper'>
            ...
            <img alt="overzicht verschillende AR-brillen" className='width-80pr' src='/img/ARBrillen.jpg' />
        </div>
        ...
        <div className='img-wrapper'>
            <div className="img-placeholder width-80pr"></div>
            <img alt="VR ervaring als dokter" className='width-80pr' src='/img/VRMedic.gif' />
        </div>
        ...
        <div className='img-wrapper'>
            <div className="img-placeholder width-80pr"></div>
            <img alt="vrouw loopt door gang met hologrammen" className='width-80pr' src='/img/ARgif.gif' />
        </div>
        ...
        <div className='img-wrapper'>
            ...
            <img alt="Raptor AR-bril" className='width-50pr' src='/img/raptor1.jpg' />
            <img alt="heads-up-display" className='width-50pr' src='/img/raptor2.jpg' />
        </div>
        ...
        <div className='img-wrapper'>
            <div className="img-placeholder width-80pr"></div>
            <img alt="google glass" className='width-80pr' src='/img/googleGlass.jpg' />
        </div>
        ...
        <div className='img-wrapper'>
            <div className="img-placeholder width-60pr"></div>
            <img alt="meta 2 AR-bril" className='width-33pr' src='/img/meta2.jpg' />
            <img alt="man draagt meta 2" className='width-33pr' src='/img/meta2.1.jpg' />
        </div>
        ...
        <div className='img-wrapper'>
            <div className="img-placeholder width-60pr"></div>
            <img alt="Third-eye AR-bril" className='width-33pr' src='/img/thirdeye1.jpg' />
            <img alt="man draagt third-eye AR-bril" className='width-33pr' src='/img/thirdeye2.jpg' />
        </div>
        ...
        <div className='img-wrapper'>
            ...
            <img alt="Microsoft HoloLens" className='width-80pr' src='/img/HoloLens.png' />
        </div>
